...
import { normalizeTheme, THEME_LABELS } from '../src/renderer/lib/themeTokens';

describe('normalizeTheme', () => {
  it('合法主题原样返回（含新增 netflix）', () => {
  ...
  it('三套皮肤都有展示名（设置页按此渲染切换项）', () => {
    expect(Object.keys(THEME_LABELS).sort()).toEqual(['dark', 'light', 'netflix']);
